...
<body>
  ...
  <div class="container-xxl container-p-y mt-5">
    <div class="misc-wrapper">
      ...
      <div class="">
        <img src="{{ asset('admin') }}/img/illustrations/403-error-forbidden.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png" />
      </div>
    </div>
  </div>
  <!-- /Error -->
